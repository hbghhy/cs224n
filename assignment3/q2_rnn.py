...
class RNNModel(NERModel):
    ...
    def add_placeholders(self):
        ...
        """
        ### YOUR CODE HERE (~4-6 lines)
        self.input_placeholder=tf.placeholder(tf.int32, shape=[None, self.max_length, self.config.n_features],name='input')
        ...
        self.dropout_placeholder=tf.placeholder(tf.float32, name='dropout_')
        ### END YOUR CODE
    ...
    def add_prediction_op(self):
        ...
        b_2=tf.get_variable("b_2",shape=[self.config.n_classes],initializer=tf.contrib.layers.xavier_initializer())
